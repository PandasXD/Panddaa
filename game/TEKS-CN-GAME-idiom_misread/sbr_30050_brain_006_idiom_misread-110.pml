...
<Package name="sbr_30050_brain_006_idiom_misread-110" format_version="4">
    <Manifest src="manifest.xml" />
    <BehaviorDescriptions>
        <BehaviorDescription name="behavior" src="." xar="behavior.xar" />
    </BehaviorDescriptions>
    <Dialogs>
        <Dialog name="title" src="dialog/title/title.dlg" />
    </Dialogs>
    <Resources>
        <File name="icon" src="icon.png" />
        <File name="idiom_misread" src="db/idiom_misread.sqlite3" />
        <File name="index" src="html/index.html" />
        <File name="home" src="html/css/home.css" />
        <File name="ranking" src="html/css/ranking.css" />
        <File name="FOT-RodinNTLGPro-B" src="html/font/FOT-RodinNTLGPro-B.woff2_en" />
        ...
        <File name="ranking_plate" src="html/images/ranking/ranking_plate.png" />
        <File name="result_plate" src="html/images/ranking/result_plate.png" />
    ...
    <Topics>
        <Topic name="title_jpj" src="dialog/title/title_jpj.top" topicName="title" language="ja_JP" />
        <Topic name="title_mnc" src="dialog/title/title_mnc.top" topicName="title" language="zh_CN" />
    </Topics>
    <IgnoredPaths>
        <Path src=".metadata" />
        <Path src="html/images/ranking_btn_on.png" />
        <Path src="html/images/question_time.png" />
        <Path src="html/images/close_btn_on.png" />
        <Path src="html/images/ranking_btn_off.png" />
        <Path src="html/images/close_btn_off.png" />
    </IgnoredPaths>
